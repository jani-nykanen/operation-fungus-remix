...
class AudioPlayer {
    ...
    // Fade in music
    public fadeInMusic(sound : any, vol = 1.0, time = 1000) {
    ...
    // Fade out music
    public fadeOutMusic(sound : any, vol = 0.0, time = 1000) {
    ...
    public setMusicVolume(v? : number) {
        ...
        this.musicSound.volume(
            v == undefined ? this.volCache : this.volCache * v);
    }


    // Play a sample
    public playSample(sound : any, vol = 1.0) {
